...
void PDQSort(SortArray& A)
{
    pdqsort(MyIterator(&A, 0), MyIterator(&A, A.size()));
}

void PDQSortBranchless(SortArray& A)
{
    pdqsort_branchless(MyIterator(&A, 0), MyIterator(&A, A.size()));
}
